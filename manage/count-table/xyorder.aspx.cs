...
public partial class count_table_xyorder : System.Web.UI.Page
{
    ...
    protected void CheckBox1_CheckedChanged(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            {
                string sqlStr = "update Order_Student set IsOK = 0 where OrderID = " + index + "";
            ...
            {
                string sqlStr = "update Order_Student set IsOK = 1 where OrderID = " + index + "";
                SqlCommand sqlComm = new SqlCommand(sqlStr, sqlConn);
                sqlComm.ExecuteNonQuery();
            }
        }
    ...
    protected void CheckBox2_CheckedChanged(object sender, EventArgs e)
    {
        ...
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            if (checkBox.Checked == false)
            {
                string sqlStr = "update Order_Student set IsLegal = 0 where OrderID = " + index + "";
                SqlCommand sqlComm = new SqlCommand(sqlStr, sqlConn);
                sqlComm.ExecuteNonQuery();
            ...
            {
                string sqlStr = "update Order_Student set IsLegal = 1 where OrderID = " + index + "";
                SqlCommand sqlComm = new SqlCommand(sqlStr, sqlConn);
                sqlComm.ExecuteNonQuery();
            }
        }
