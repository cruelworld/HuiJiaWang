<%@ Page Title="教员注册" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Signup_Teacher.aspx.cs" Inherits="Account_Signup_Teacher" %>
    ...
    <div class="col-sm-10">
      <form runat="server" class="form-horizontal">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">            
            <input id="Colleges" type="radio" class="radio-inline" name="Type" /><label>&nbsp 在校大学生（包括研究生）</label> <br />
            <input id="Teachers" type="radio" class="radio-inline" name="Type" /><label>&nbsp 教师（在职、进修、离职、退休）</label><br />            
            <input id="Others" type="radio" class="radio-inline" name="Type" /><label>&nbsp 其他（毕业人员、工作人员、留学生、外籍教师等）</label><br />                        
          </div>          
        </div>        <br />
        <div class="form-group">
          <div class="col-sm-6 col-sm-offset-2">
              <asp:CheckBox ID="CheckBox1" runat="server" />
            <label>&nbsp 我已阅读并接受《<a class="text-info" href="../article/Article10.aspx">教员注册协议</a>》</label><br />
          </div>          
          <label class="col-sm-2">
            <abbr title="通过与徽教网签订合同协议、缴纳一定的保障金后的认证身份">
              <span class="glyphicon glyphicon-exclamation-sign"></span>签约教员
            </abbr></label><br />
