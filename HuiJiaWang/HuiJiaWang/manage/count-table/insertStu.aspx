<%@ Page Language="C#" AutoEventWireup="true" CodeFile="insertStu.aspx.cs" MaintainScrollPositionOnPostback="true" Inherits="count_table_insertStu" %>
        ...
        <table border="1" cellpadding="0" cellspacing="0" class="style1" frame="above" 
            ...
            <tr>
                ...
                <td class="style21" rowspan="13">
                    &nbsp;</td>
                <td class="style16" align="right" rowspan="2">
                    求教课科目：</td>
            ...
            <tr>
                <td class="style10" align="right" rowspan="2">
                    &nbsp;&nbsp;
                    邮箱：&nbsp;&nbsp;&nbsp;&nbsp;</td>
